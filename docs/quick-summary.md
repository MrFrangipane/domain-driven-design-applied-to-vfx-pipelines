...
![Image borrowed from Herberto Graça's Architecture Chronicles. Recommended reading.](010-explicit-architecture-svg.png)

![Images borrowed from Herberto Graça's Architecture Chronicles. Recommended reading.](070-explicit-architecture-svg.png)
